						...
						{data.panenPredictions.map((prediction, index) => (
							<div key={index} className="bg-green-50 rounded-lg p-4">
								<div className="flex justify-between items-center mb-2">
									...
									<span className="text-sm text-gray-600">Rak {prediction.rak}</span>
								</div>
								<div className="flex justify-between items-center mb-2">
					...
					<div className="space-y-4">
						{data.riskAssessments.map((risk, index) => (
							<div key={index} className="bg-orange-50 rounded-lg p-4">
								<div className="flex justify-between items-center mb-2">
									<span className="font-semibold text-orange-800">{risk.jenis}</span>
					...
					<div className="space-y-4">
						{data.maintenanceSchedule.map((item, index) => (
							<div key={index} className="bg-blue-50 rounded-lg p-4">
								<div className="flex justify-between items-center mb-2">
									<span className="font-semibold text-blue-800">{item.peralatan}</span>
					...
					<div className="space-y-3">
						{data.energyTrends.map((trend, index) => (
							<div
								...
								<span className="font-medium text-purple-800">{trend.tanggal}</span>
								<div className="flex gap-4">
									<span className="text-sm text-gray-600">{trend.konsumsi}kWh</span>
									<span className="text-sm text-green-600">{trend.produksi}kWh</span>
