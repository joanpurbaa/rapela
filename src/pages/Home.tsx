...
const Home: React.FC = () => {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50 p-4 md:p-8">
			<div className="mb-8">
				<h1 className="text-4xl font-bold text-green-800 mb-2">Smart AeroFarm</h1>
				<p className="text-gray-600">Bojongsoang Vertical Farming Control Center</p>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				<div className="bg-white rounded-2xl shadow-lg p-6 border border-green-100 hover:shadow-xl transition-shadow">
					<div className="flex items-center justify-between mb-4">
						<h3 className="text-lg font-semibold text-gray-800">Kondisi Nutrisi</h3>
					...
					<div className="space-y-4">
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="bg-blue-50 rounded-lg p-3">
								...
								<p className="text-xl font-bold text-blue-700">{data.nutrisi.ph}</p>
							</div>
							<div className="bg-blue-50 rounded-lg p-3">
					...
					<div className="space-y-4">
						<div className="bg-cyan-50 rounded-lg p-4">
							...
							<div className="flex items-center justify-between">
								<span
									className={`text-lg font-bold ${getStatusColor(data.air.kualitas)}`}>
				...
				<div className="bg-white rounded-2xl shadow-lg p-6 border border-purple-100 hover:shadow-xl transition-shadow">
					<div className="flex items-center justify-between mb-4">
						<h3 className="text-lg font-semibold text-gray-800">Kontrol Cepat</h3>
				...
				<div className="bg-white rounded-2xl shadow-lg p-6 border border-yellow-100 hover:shadow-xl transition-shadow">
					<div className="flex items-center justify-between mb-4">
						<h3 className="text-lg font-semibold text-gray-800">Optimasi Energi</h3>
					...
					<div className="space-y-4">
						<div className="relative pt-1">
							...
							<div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-yellow-200">
								<div
									style={{
										width: `${(data.energi.surya / data.energi.konsumsi) * 100}%`,
									}}
						...
						<div className="bg-green-50 rounded-lg p-4">
							<p className="text-xs text-gray-600 mb-1">Penghematan Bulan Ini</p>
				...
				<div className="bg-white rounded-2xl shadow-lg p-6 border border-green-100 hover:shadow-xl transition-shadow">
					<div className="flex items-center justify-between mb-4">
						<h3 className="text-lg font-semibold text-gray-800">Kalender Tanam</h3>
						...
						{data.kalenderTanam.map((item) => (
							<div key={item.rak} className="bg-green-50 rounded-lg p-4">
								<div className="flex justify-between items-center mb-2">
									<span className="font-semibold text-green-800">Rak {item.rak}</span>
									<span className="text-sm text-gray-600">{item.tanaman}</span>
								</div>
								<div className="w-full bg-green-200 rounded-full h-2 mb-2">
									<div
										className="bg-green-600 h-2 rounded-full transition-all"
										style={{ width: `${(item.hari / item.totalHari) * 100}%` }}
									/>
								</div>
					...
					<div className="space-y-4">
						...
						<div className="bg-orange-50 rounded-lg p-4">
							<div className="flex items-center gap-2 mb-2">
								...
								<p className="text-sm text-gray-600">Maintenance Berikutnya</p>
							</div>
				...
				<div className="bg-white rounded-2xl shadow-lg p-6 border border-emerald-100 hover:shadow-xl transition-shadow">
					<div className="flex items-center justify-between mb-4">
						<h3 className="text-lg font-semibold text-gray-800">Diagnosa Tanaman</h3>
					...
					<div className="space-y-4">
						...
						<div className="bg-emerald-50 rounded-lg p-4">
							...
							<div className="flex items-center gap-2">
								<CheckCircle className="w-5 h-5 text-green-500" />
								<span className="font-medium text-green-700">Semua Tanaman Sehat</span>
							</div>
						</div>
						...
						<div className="bg-blue-50 rounded-lg p-4">
							...
							<p className="text-sm text-blue-800">
								Lanjutkan perawatan rutin. Monitor kelembapan rak B.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="bg-white rounded-2xl shadow-lg p-6 border border-pink-100 hover:shadow-xl transition-shadow">
					...
					<div className="space-y-4">
						<div className="bg-pink-50 rounded-lg p-4">
							<p className="text-sm text-gray-600 mb-1">Harga Pasar Hari Ini</p>
							<p className="text-sm text-pink-800 font-medium">Selada: Rp 25.000/kg</p>
							<p className="text-sm text-pink-800 font-medium">Bayam: Rp 18.000/kg</p>
						</div>

						<div className="bg-green-50 rounded-lg p-4">
							<p className="text-sm text-gray-600 mb-2">Permintaan Tinggi</p>
							<div className="flex items-center gap-2">
			...
			<div className="mt-8 text-center text-gray-500 text-sm">
				<p>Smart AeroFarm Dashboard v1.0 - Bojongsoang Vertical Farming</p>
				<p className="mt-1">Powered by IoT & AI Technology</p>
			</div>
		</div>
	);
};
